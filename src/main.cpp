...
void renderQuad() {
    ...
    // calculate tangen/biteangent of traingles
    glm::vec3 tangent1, bitangent1, tangent2, bitangent2;

    // triangle 1
    glm::vec3 edge1 = pos2 - pos1;
    glm::vec3 edge2 = pos3 - pos1;
    glm::vec2 deltaUV1 = uv2 - uv1; // 0, -1
    glm::vec2 deltaUV2 = uv3 - uv1; // 1, -1

    // determinant
    float f = 1.0f / (deltaUV1.x * deltaUV2.y - deltaUV2.x * deltaUV1.y);

    // combined calculation of the inverse multiplied by edge
