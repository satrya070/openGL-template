...
unsigned int planeVAO; // set global to be called anywhere
...
int main()
{
    ...
    Shader depthShader = Shader("../../../shaders/depth_v_shader.txt", "../../../shaders/depth_f_shader.txt");
    Shader debugShader = Shader("../../../shaders/db_vertex.txt", "../../../shaders/db_fragment.txt");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 lightProjection = glm::ortho(-10.f, 10.0f, -10.0f, 10.0f, near_plane, far_plane);
